...
raw: como o r² foi 0.814 (alto), isso signifca que o modelo explica 81% da variação dos dados. 
raw: o pvalor é bastante baixo, então a relação entre os variáveis não é ao acaso;
raw: o intervalo de confiança é positivo então há relação significativa entre as variáveis;
